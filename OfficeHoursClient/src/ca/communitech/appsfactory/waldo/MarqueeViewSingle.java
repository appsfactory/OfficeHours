...
public class MarqueeViewSingle extends LinearLayout {
     ...
     */
    public static final int MS_PER_PX = 15;
 
    /**
     * Control the pause between the animations. Also, after starting this activity.
     */
    public static final int PAUSE_BETWEEN_ANIMATIONS = 100;
...
//                mMoveText1TextOutPlaying = false;
    ...
    public void setText1(String text) {
        ...
        mTextField1.setTextSize(150);
        mTextField1.setTextColor(Color.argb(255, 33, 33, 33));
        mTextField1.setTypeface(SignInChecker.metro);
    }
